...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) 
{
	...
	for(float i=0.; i < iSamples; i++) 
	{
		vec2 p = iScale * (2.*fragCoord-R+nextRand2())/R.y - iPosition;
		float orbit = mandelbrot(p) / iMaxIter;
